...
#define TEST_SURFACE
    ...
    auto reg = new FemObj();  //regular
    reg->regularTriangulate(1,5,8);
    reg->computeNormals();
    reg->computeM();
    reg->replot();
    reg->translate(GMlib::Vector<float,3>( 10.0f, 0.0f, 0.0f));
    _scene->insert(reg);

    auto ran = new FemObj();  //random
    ran->randomTriangulate(5.0f,300);   //problems
...
//    auto Regu = new FemObj();
//    Regu->connectRegular(4,20);
...
//    auto a = new MYPlane<float>(GMlib::Point<float,3>(-5,5,-1),GMlib::Point<float,3>(5,5,-1),GMlib::Point<float,3>(5,-5,-1),GMlib::Point<float,3>(-5,-5,-1));
//    a->toggleDefaultVisualizer();
//    a->setMaterial(GMlib::GMmaterial::Gold);
//    a->replot(200,200,1,1);
//    _scene->insert(a);

//    // plane2

//    auto b = new MYPlane<float>(GMlib::Point<float,3>(-5,5,3),GMlib::Point<float,3>(-5,5,-1),GMlib::Point<float,3>(-5,-5,-1),GMlib::Point<float,3>(-5,-5,3));
//    b->toggleDefaultVisualizer();

//    b->replot(200,200,1,1);
//    _scene->insert(b);

//    // plane3

//    auto c = new MYPlane<float>(GMlib::Point<float,3>(-5,5,3),GMlib::Point<float,3>(5,5,3),GMlib::Point<float,3>(5,5,-1),GMlib::Point<float,3>(-5,5,-1));
//    c->toggleDefaultVisualizer();

//    c->replot(200,200,1,1);
//    _scene->insert(c);
...
//-----------------------------------------------------------------------------------
   ...
   // auto surface_visualizer = new GMlib::PSurfPointsVisualizer<float,3>;
    ...
    //Surface box
//    auto surface3 = new Testplane;
//    surface3->toggleDefaultVisualizer();
//    surface3->insertVisualizer(surface_visualizer);
//   // surface3->translate(GMlib::Vector<float,3>( 0.0f, 3.0f, 0.0f));
//    surface3->replot(200,200,1,1);
//    _scene->insert(surface3);

    //surface->test02();


//-------------------------------------------------------------------
//    auto a = new MYPlane<float>(GMlib::Point<float,3>(0,0,0),GMlib::Point<float,3>(1,0,0),GMlib::Point<float,3>(0,1,0),GMlib::Point<float,3>(1,1,1));
//    a->toggleDefaultVisualizer();
...
//    a->replot(200,200,1,1);
    ...
    //_scene->insert(a);
    // sphere
//    auto sphere = new Testsphere;
//    sphere->toggleDefaultVisualizer();
//    sphere->insertVisualizer(surface_visualizer);
//    sphere->setMaterial(GMlib::GMmaterial::BlackPlastic);
//    sphere->setVelocity(GMlib::Vector<float,3>( 0.0f, 2.0f, 0.0f));
//    sphere->translate(GMlib::Vector<float,3>( 0.0f, 3.0f, 0.0f));
//    sphere->replot(200,1,1,1);
//    //sphere->setDs(GMlib::Vector<float,3>( 0.0f, 5.0f, 0.0f));
//    _scene->insert(sphere);


    // sphere2
//    auto sphere2 = new Testsphere;
//    sphere2->toggleDefaultVisualizer();
//    sphere2->insertVisualizer(surface_visualizer);
//    sphere2->setMaterial(GMlib::GMmaterial::Jade);
//    sphere2->translate(GMlib::Vector<float,3>( -2.0f, -1.0f, 0.0f));
//    sphere2->replot(200,200,1,1);
//    sphere2->setVelocity(GMlib::Vector<float,3>( 0.0f, 1.0f, 0.0f));
//    _scene->insert(sphere2);


    // sphere3
//    auto sphere3 = new Testsphere;
//    sphere3->toggleDefaultVisualizer();
//    sphere3->insertVisualizer(surface_visualizer);
//    sphere3->translate(GMlib::Vector<float,3>( -3.0f, 3.0f, 0.0f));
//    sphere3->setVelocity(GMlib::Vector<float,3>( 2.0f, 0.0f, 0.0f));
//    sphere3->replot(200,200,1,1);
//    _scene->insert(sphere3);



//    GMlib::DMatrix<GMlib::Vector<float,3>> m(3,3);
//    m[0][0] = GMlib::Vector<float,3>(1,1,4);
//    m[0][1] = GMlib::Vector<float,3>(0,1,3);
//    m[0][2] = GMlib::Vector<float,3>(0,1,2);
//    m[1][0] = GMlib::Vector<float,3>(1,2,1);
//    m[1][1] = GMlib::Vector<float,3>(0,2,0);
//    m[1][2] = GMlib::Vector<float,3>(1,2,1);
//    m[2][0] = GMlib::Vector<float,3>(2,3,2);
//    m[2][1] = GMlib::Vector<float,3>(3,3,3);
//    m[2][2] = GMlib::Vector<float,3>(1,3,4);

//    auto nine =new MYPlanenine<float>(m);

//            nine->toggleDefaultVisualizer();

//    nine->replot(200,200,1,1);
//    _scene->insert(nine);
